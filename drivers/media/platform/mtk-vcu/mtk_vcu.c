...
static struct mtk_vcu_queue *mtk_vcu_dec_init(struct device *dev)
{
...
static void mtk_vcu_dec_release(struct mtk_vcu_queue *vcu_queue)
{
...
static void *mtk_vcu_get_buffer(struct mtk_vcu_queue *vcu_queue,
...
static int mtk_vcu_free_buffer(struct mtk_vcu_queue *vcu_queue,
						struct mem_obj *mem_buff_data)
{
	struct mtk_vcu_mem *vcu_buffer;
	void *cook, *dma_addr;
...
static int vcu_buffer_flush_all(struct device *dev, struct mtk_vcu_queue *vcu_queue)
{
	struct mtk_vcu_mem *vcu_buffer;
...
static int vcu_buffer_cache_sync(struct device *dev, struct mtk_vcu_queue *vcu_queue,
